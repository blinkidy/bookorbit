        ...
        children: [
          ...
          },
          {
            ...
            meta: {
              ...
              permissionFallback: 'settings-account-profile',
              maxWidth: 'max-w-4xl',
              title: () => t('titles.metadata.custom-fields'),
            },
          },
          {
            path: 'metadata/score',
          ...
          },
          {
            ...
            meta: {
              ...
              permissionFallback: 'settings-account-profile',
              maxWidth: 'max-w-3xl',
              title: () => t('titles.metadata.auto-fetch'),
            },
          },
          {
            ...
            meta: {
              ...
              permissionFallback: 'settings-account-profile',
              maxWidth: 'max-w-3xl',
              title: () => t('titles.metadata.authors'),
            },
          },
          {
            ...
            meta: {
              ...
              permissionFallback: 'settings-account-profile',
              maxWidth: 'max-w-3xl',
              title: () => t('titles.metadata.genre-blocklist'),
            },
          },
          {
          ...
          },
          {
            ...
            meta: {
              ...
              permissionFallback: 'settings-account-profile',
              maxWidth: 'max-w-3xl',
              title: () => t('titles.system.maintenance'),
            },
          },
          ...
          // ── Devices & sync ─────────────────────────────────────────────────
          {
            ...
            meta: {
              requiredPermission: Permission.KoboSync,
              permissionFallback: 'settings-account-profile',
              maxWidth: 'max-w-4xl',
              title: () => t('titles.koboSync'),
            },
          },
          {
            path: 'koreader',
            ...
            meta: {
              requiredPermission: Permission.KoreaderSync,
              permissionFallback: 'settings-account-profile',
              maxWidth: 'max-w-4xl',
          ...
          },
          {
            ...
            meta: {
              requiredPermission: Permission.OpdsAccess,
              permissionFallback: 'settings-account-profile',
              title: () => t('titles.opds'),
            },
          },
          ...
          },
          {
            ...
            props: { embedded: true },
            meta: {
              requiredPermission: Permission.HardcoverSync,
              permissionFallback: 'settings-account-profile',
              maxWidth: 'max-w-3xl',
              title: () => t('settings.integrations.tabs.hardcover'),
            },
          },
          {
            path: 'readwise',
            ...
            props: { embedded: true },
            meta: {
              requiredPermission: Permission.ReadwiseSync,
              permissionFallback: 'settings-account-profile',
              maxWidth: 'max-w-3xl',
          ...
          },
          {
            ...
            props: { embedded: true },
            meta: {
              requiredPermission: Permission.StorygraphSync,
              permissionFallback: 'settings-account-profile',
              maxWidth: 'max-w-3xl',
          ...
          },
          {
            ...
            meta: {
              requiredPermission: Permission.ViewUserActivity,
              permissionFallback: 'settings-account-profile',
              maxWidth: 'max-w-6xl',
              title: () => t('titles.admin.account-activity'),
            },
          },
          {
          ...
          },
          {
            ...
            meta: {
              ...
              permissionFallback: 'settings-account-profile',
              maxWidth: 'max-w-5xl',
              title: () => t('titles.admin.magic-links'),
            },
          },
          {
            path: 'admin/oidc',
          ...
          },
          {
            ...
            meta: {
              ...
              permissionFallback: 'settings-account-profile',
              maxWidth: 'max-w-3xl',
              title: () => t('titles.admin.server-fonts'),
            },
          },
          {
            ...
            props: { embedded: true },
            meta: {
              requiredPermission: Permission.ManageBookDock,
              permissionFallback: 'settings-account-profile',
              maxWidth: 'max-w-3xl',
              title: () => t('titles.system.book-dock'),
            },
          },
          {
            ...
            meta: {
              ...
              title: () => t('titles.system.audit-log'),
            },
          },
