CREATE TABLE "kosync_audiobook_sessions" (
	...
	"last_external_sync_at" timestamp with time zone,
	"last_external_sync_progress" real,
	...
	CONSTRAINT "kas_last_external_sync_progress_range_chk" CHECK ("kosync_audiobook_sessions"."last_external_sync_progress" is null or ("kosync_audiobook_sessions"."last_external_sync_progress" >= 0 and "kosync_audiobook_sessions"."last_external_sync_progress" <= 100)),
...
CREATE INDEX "kas_user_id_idx" ON "kosync_audiobook_sessions" USING btree ("user_id");--> statement-breakpoint
ALTER TABLE "reading_sessions" ADD CONSTRAINT "reading_sessions_source_chk" CHECK ("reading_sessions"."source" in ('web', 'koreader', 'manual', 'kobo', 'audiobook'));