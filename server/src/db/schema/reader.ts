...
export const readingSessions = pgTable(
  'reading_sessions',
  {
    ...
    // 'web' (browser reader) | 'koreader' (page-stats derivation) | 'manual' (user-entered) | 'kobo' | 'audiobook'
  ...
  (t) => [
    ...
    check('reading_sessions_source_chk', sql`${t.source} in ('web', 'koreader', 'manual', 'kobo', 'audiobook')`),
